...
<body>
	...
	<form action="modnoteform.jsp" method="POST">
	<div class="footer-1">
				      ...
				      <div class="form-check">
				        ...
				        <c:choose>
				          <c:when test="${confirm eq 'Y'}">
				            <input name="check" class="form-check-input" type="radio" value="<%=no%>" disabled="">
				          </c:when>
				          <c:otherwise>
				            <input name="check" class="form-check-input" type="radio" value="<%=no%>">
				          </c:otherwise>
				        </c:choose>  
				      </div>
				    </td>
